...
import { getAuth,
         ...
         onAuthStateChanged,
         GoogleAuthProvider,
         signInWithPopup } from "https://www.gstatic.com/firebasejs/9.15.0/firebase-auth.js"
import { getFirestore,
         collection,
         addDoc, 
         serverTimestamp,
         ...
         updateDoc,
         doc, 
         deleteDoc} from "https://www.gstatic.com/firebasejs/9.15.0/firebase-firestore.js"

/* === Firebase Setup === */
const firebaseConfig = {
  apiKey: "AIzaSyAME8sQeFVdQhi8_km3i2tcLWUXmRNRJUk",
  authDomain: "doody-47791.firebaseapp.com",
  projectId: "doody-47791",
  storageBucket: "doody-47791.firebasestorage.app",
};
